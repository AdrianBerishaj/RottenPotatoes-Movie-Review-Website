...
CREATE TABLE `review` (
  ...
  `REVIEW_DESC` char(255) DEFAULT NULL,
  PRIMARY KEY (`REVIEW_ID`,`MOVIE_ID`,`USER_ID`),
  KEY `USER_ID_FK1_idx` (`USER_ID`),
  KEY `MOVIE_ID_FK4_idx` (`MOVIE_ID`),
  CONSTRAINT `MOVIE_ID_FK4` FOREIGN KEY (`MOVIE_ID`) REFERENCES `movie` (`MOVIE_ID`),
